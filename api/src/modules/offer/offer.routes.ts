...
import { authGuard, optionalAuthGuard } from '../../shared/guards/auth.guard.js'
...
export async function offerRoutes(app: FastifyInstance) {
  ...
  app.get('/ofertas', { preHandler: [optionalAuthGuard] }, listController) // público, mas exclui a própria oferta se logado
